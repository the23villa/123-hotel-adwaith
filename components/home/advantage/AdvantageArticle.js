...
const AdvantageArticle = () => {
  const items = [
    ...
    },
    {
      ...
      description:
        "Our Hotels are 100% stress-free so you can fully enjoy your experience. Once paid you don’t have to worry about being nickel and dimed along the way. Leave your wallet at home.",
    },
  ];

  return (
    <article className="flex flex-col gap-y-8">
      <h2 className="lg:text-4xl md:text-3xl text-2xl font-serif">
        Inviting You to a Secure Stay
        <LoadImage
